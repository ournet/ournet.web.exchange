...
extern.maxageJson = function(res) {
...
extern.formatRateKeys = function(country, dates, sources, currencies) {
  var data = [];
  ...
  sources.forEach(function(source) {
    dates.forEach(function(date) {
      currencies.forEach(function(currency) {
        data.push(exchange.util.formatRateKey(country, date, source, currency));
      });
    });
  });
